package com.nicolas.expenses_tracker.security.config;

import com.nicolas.expenses_tracker.security.jwt.JWTFilter;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("http://localhost:3000", "https://expenses-tracker-client-ten.vercel.app/"));
